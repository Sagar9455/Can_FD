        ...
        while True:
            if GPIO.input(BUTTON_PIN) == GPIO.LOW:
                ...
                for action, uds_function in steps:
                    ...
                    report_data.append({"timestamp": timestamp, "response_timestamp": response_timestamp, "action": action, "request_status": request_status, "response_status": response_status, "failure_reason": failure_reason})
                    time.sleep(0.5)
