    ...
    with Client(conn, request_timeout=2, config=config) as client:
        ...
        for tc_id, steps in grouped_cases.items():
            for step in steps:
                ...
                # Appending both Request Sent and Response Received data
                report.append({
                   "id": tc_id,
                   "timestamp": timestamp,
                ...
                # Here you could also append a response step if needed
                # You would need to handle the "Response Received" similarly
